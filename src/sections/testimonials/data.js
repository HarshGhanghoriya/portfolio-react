...
const data=[
    ...
    {
        id:2,
        quote: 'Jitesh expertise in ReactJS is truly impressive. He have deep understanding of the framework and its ecosystem, allowing them to build dynamic and interactive user interfaces with ease. His attention to detail is remarkable, as he meticulously craft every element of his projects to ensure a seamless user experience.',
        avatar: Avatar2,
        name: 'Ravi Ranwa',
        profession: 'SDE 2, Intuit'
    },
    {
        id:3,
